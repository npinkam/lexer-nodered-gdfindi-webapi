...
<body>
${headerContent(header)}
<div class='title'>GD.findi / Production Plan Scheduling</div>
<div id='vfk-body'>
${body}
</div>
<div id="stepper" style="padding-top: 50px;">
  <div class="md-stepper-horizontal orange">
    <div class="md-step ${curStep[0]}">
      <div class="md-step-circle"><span>1</span></div>
      <div class="md-step-title">Select Project</div>
      <div class="md-step-bar-left"></div>
      <div class="md-step-bar-right"></div>
    </div>
    <div class="md-step ${curStep[1]}">
      <div class="md-step-circle"><span>2</span></div>
      <div class="md-step-title">Submit to PVDO</div>
      <div class="md-step-bar-left"></div>
      <div class="md-step-bar-right"></div>
    </div>
    <div class="md-step ${curStep[2]}">
